Game.registerMod("A Hat in Time Music", {
	init: function () {
		...
		Music.addTrack('The Battle of Award 42', 'Pascal Michael Stiefel', this.dir + '/40TheBattleofAward42.mp3');
		Music.addTrack('Heart To Heart', 'Pascal Michael Stiefel', this.dir + '/41HeartToHeart.mp3');
		Music.addTrack('Your Contract has expired', 'Pascal Michael Stiefel', this.dir + '/55YourContractHasExpired.mp3');
