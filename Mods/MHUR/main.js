...
MoreHeavenlyUpgradesRemastered.launch = function() {
    ...
    MoreHeavenlyUpgradesRemastered.init = function() {
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][3], `Each ${buildingTiers[12][0]} gains <b>+${baseCpsIncrease}%</b> base CpS per ${buildingTiers[12][0]}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), WatsonIcons ? [22, 0, WatsonIcons] : [8, 22], -1300, -800, [buildingTiers[10][3]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][2], `Sugar lumps mature <b>${12*scalingBaseReduce/second} seconds</b> sooner per ${buildingTiers[12][0]}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), WatsonIcons ? [23, 0, WatsonIcons] : [8, 36], -350, -2500, [sugarLumpSpecial[3]]);
