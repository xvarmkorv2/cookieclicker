...
MoreHeavenlyUpgradesRemastered.launch = function() {
    ...
    MoreHeavenlyUpgradesRemastered.init = function() {
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][1], `Sugar lumps mature <b>${12*staticBasereduce/minute} minutes</b> sooner.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), WatsonIcons ? [26, 0, watsonicons] : [8, 30], -450, -2500, [sugarLumpSpecial[3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][2], `Sugar lumps mature <b>${12*scalingBaseReduce/second} seconds</b> sooner per ${buildingTiers[12][0]}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), WatsonIcons ? [21, 0, watsonicons] : [8, 36], -350, -2500, [sugarLumpSpecial[3]]);
