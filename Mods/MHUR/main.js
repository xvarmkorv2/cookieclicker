...
MoreHeavenlyUpgradesRemastered.version = '2.112';
...
MoreHeavenlyUpgradesRemastered.launch = function() {
    ...
    const buildingConvertor = (building) => {
        return building
    }
    ...
    MoreHeavenlyUpgradesRemastered.init = function() {
        ...
        const WatsonIcons = (Game.mods["despacito AmeliaWatson"] !== undefined ? Game.mods["despacito AmeliaWatson"].dir + "/watsoniconfull.png" : 0) || (App && CheckForWatson(App.mods) ? App.mods["despacito AmeliaWatson"].dir + "/watsoniconfull.png" : 0) || (Mods && CheckForWatson(Mods.ModData) ? Mods.ModData["despacito AmeliaWatson"].dir + "/watsoniconfull.png" : 0)
        if (WatsonIcons) {
            buildingTiers[12] = ['Time machine', 'Sugar lumps from the past', 'Time-altering process', 'Embrace Amelia Watsons', 'Amelia Watson on your hands', 'Better Luck XII', 'Intensified Luck XII']
        }
        ...
        //CPS TIER 1
        CCSE.NewHeavenlyUpgrade(buildingTiers[1][3], `Each ${Game.Objects[buildingTiers[1][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[1][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [0, 32], -1750, -500, [cpsSpecial[1]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[2][3], `Each ${Game.Objects[buildingTiers[2][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[2][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [1, 32], -1600, -650, [cpsSpecial[1]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[3][3], `Each ${Game.Objects[buildingTiers[3][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[3][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [2, 32], -1900, -550, [buildingTiers[1][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[4][3], `Each ${Game.Objects[buildingTiers[4][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[4][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [3, 32], -1700, -800, [buildingTiers[2][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[5][3], `Each ${Game.Objects[buildingTiers[5][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[5][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [4, 32], -2100, -650, [buildingTiers[3][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[6][3], `Each ${Game.Objects[buildingTiers[6][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[6][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [15, 32], -1900, -900, [buildingTiers[4][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[7][3], `Each ${Game.Objects[buildingTiers[7][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[7][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [16, 32], -2200, -750, [buildingTiers[5][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[8][3], `Each ${Game.Objects[buildingTiers[8][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[8][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [17, 32], -2100, -950, [buildingTiers[6][3]]);
        ...
        //CPS TIER 2
        CCSE.NewHeavenlyUpgrade(buildingTiers[9][3], `Each ${Game.Objects[buildingTiers[9][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[9][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [5, 32], -1250, -500, [cpsSpecial[1]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[10][3], `Each ${Game.Objects[buildingTiers[10][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[10][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [6, 32], -1400, -650, [cpsSpecial[1]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[11][3], `Each ${Game.Objects[buildingTiers[11][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[11][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [7, 32], -1100, -550, [buildingTiers[9][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][3], `Each ${Game.Objects[buildingTiers[12][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[12][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), WatsonIcons ? [22, 0, WatsonIcons] : [8, 22], -1300, -800, [buildingTiers[10][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[13][3], `Each ${Game.Objects[buildingTiers[13][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[13][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [13, 32], -900, -650, [buildingTiers[11][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[14][3], `Each ${Game.Objects[buildingTiers[14][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[14][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [14, 32], -1100, -900, [buildingTiers[12][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[15][3], `Each ${Game.Objects[buildingTiers[15][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[15][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [19, 32], -800, -750, [buildingTiers[13][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[16][3], `Each ${Game.Objects[buildingTiers[16][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[16][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [20, 32], -900, -950, [buildingTiers[14][3]]);
        ...
        //CPS TIER 3
        let stem = CCSE.NewHeavenlyUpgrade(buildingTiers[17][3], `Each ${Game.Objects[buildingTiers[17][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[17][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [32, 32], -1500, -600, [cpsSpecial[1]]);
        stem.showIf = function() {
            if (Game.Has(cpsSpecial[2]) && Game.Has(cpsSpecial[3]))
                return true;
        }
        CCSE.NewHeavenlyUpgrade(buildingTiers[18][3], `Each ${Game.Objects[buildingTiers[18][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[18][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [33, 32], -1500, -750, [buildingTiers[17][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[19][3], `Each ${Game.Objects[buildingTiers[19][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[19][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [34, 32], -1500, -900, [buildingTiers[18][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[20][3], `Each ${Game.Objects[buildingTiers[20][0]].dname} gains <b>+${baseCpsIncrease}%</b> base CpS per ${Game.Objects[buildingTiers[20][0]].dname}</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [35, 32], -1500, -1050, [buildingTiers[19][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[1][4], `${Game.Objects[buildingTiers[1][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [0, 29], -1500, -1200, [buildingTiers[20][3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[2][4], `${Game.Objects[buildingTiers[2][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [1, 29], -1500, -1350, [buildingTiers[1][4]]);
        ...
        //CPS TIER 4
        CCSE.NewHeavenlyUpgrade(buildingTiers[3][4], `${Game.Objects[buildingTiers[3][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [2, 29], -1575, -1500, [cpsSpecial[4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[4][4], `${Game.Objects[buildingTiers[4][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [3, 29], -1675, -1525, [buildingTiers[3][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[5][4], `${Game.Objects[buildingTiers[5][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [4, 29], -1775, -1575, [buildingTiers[4][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[6][4], `${Game.Objects[buildingTiers[6][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [15, 29], -1825, -1650, [buildingTiers[5][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[7][4], `${Game.Objects[buildingTiers[7][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [16, 29], -1850, -1725, [buildingTiers[6][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[8][4], `${Game.Objects[buildingTiers[8][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [17, 29], -1850, -1825, [buildingTiers[7][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[9][4], `${Game.Objects[buildingTiers[9][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [5, 29], -1825, -1900, [buildingTiers[8][4]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[10][4], `${Game.Objects[buildingTiers[10][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [6, 29], -1650, -1925, [cpsSpecial[5]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[11][4], `${Game.Objects[buildingTiers[11][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [7, 29], -1575, -2000, [buildingTiers[10][4]]);

        // //CPS TIER 5
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][4], `${Game.Objects[buildingTiers[12][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), WatsonIcons ? [20, 0, WatsonIcons] : [8, 29], -1425, -1500, [cpsSpecial[4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[13][4], `${Game.Objects[buildingTiers[13][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [13, 29], -1325, -1525, [buildingTiers[12][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[14][4], `${Game.Objects[buildingTiers[14][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [14, 29], -1225, -1575, [buildingTiers[13][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[15][4], `${Game.Objects[buildingTiers[15][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [19, 29], -1175, -1650, [buildingTiers[14][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[16][4], `${Game.Objects[buildingTiers[16][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [20, 29], -1150, -1725, [buildingTiers[15][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[17][4], `${Game.Objects[buildingTiers[17][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [32, 29], -1150, -1825, [buildingTiers[16][4]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[18][4], `${Game.Objects[buildingTiers[18][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [33, 29], -1175, -1900, [buildingTiers[17][4]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[19][4], `${Game.Objects[buildingTiers[19][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [34, 29], -1350, -1925, [cpsSpecial[6]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[20][4], `${Game.Objects[buildingTiers[20][0]].dname} levels boost clicks by <b>${boostClick}%</b>.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** cpsUpgrade++), [35, 29], -1425, -2000, [buildingTiers[19][4]]);
        ...
        for (let i = 1; i <= Object.keys(buildingTiers).length; i++) {
            Game.customBuildings[buildingConvertor(buildingTiers[i][0])].cpsMult.push(function() {
                ...
                if (buildingTiers[i][3] && Game.Has(buildingTiers[i][3]))
                    cpsMultiplier *= 1 + toPercent(Game.Objects[buildingConvertor(buildingTiers[i][0])].amount);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[1][2], `Sugar lumps mature <b>${1 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[1][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [0, 36], -650, -1700, [sugarLumpSpecial[1]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[2][2], `Sugar lumps mature <b>${2 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[2][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [1, 36], -350, -1700, [sugarLumpSpecial[1]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[3][2], `Sugar lumps mature <b>${3 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[3][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [2, 36], -50, -1700, [sugarLumpSpecial[1]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[4][2], `Sugar lumps mature <b>${4 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[4][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [3, 36], 250, -1700, [sugarLumpSpecial[1]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[5][2], `Sugar lumps mature <b>${5 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[5][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [4, 36], 550, -1700, [sugarLumpSpecial[1]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[6][2], `Sugar lumps mature <b>${6 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[6][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [15, 36], -650, -2100, [sugarLumpSpecial[2]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[7][2], `Sugar lumps mature <b>${7 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[7][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [16, 36], -350, -2100, [sugarLumpSpecial[2]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[8][2], `Sugar lumps mature <b>${8 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[8][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [17, 36], -50, -2100, [sugarLumpSpecial[2]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[9][2], `Sugar lumps mature <b>${9 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[9][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [5, 36], 250, -2100, [sugarLumpSpecial[2]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[10][2], `Sugar lumps mature <b>${10 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[10][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [6, 36], 550, -2100, [sugarLumpSpecial[2]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[11][2], `Sugar lumps mature <b>${11 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[11][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [7, 36], -650, -2500, [sugarLumpSpecial[3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][1], `Sugar lumps mature <b>${12 * staticBasereduce / minute} minutes</b> sooner.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), WatsonIcons ? [20, 0, WatsonIcons] : [8, 30], -450, -2500, [sugarLumpSpecial[3]]);
        CCSE.NewHeavenlyUpgrade(buildingTiers[12][2], `Sugar lumps mature <b>${12 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[12][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), WatsonIcons ? [23, 0, WatsonIcons] : [8, 36], -350, -2500, [sugarLumpSpecial[3]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[13][2], `Sugar lumps mature <b>${13 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[13][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [13, 36], -50, -2500, [sugarLumpSpecial[3]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[14][2], `Sugar lumps mature <b>${14 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[14][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [14, 36], 250, -2500, [sugarLumpSpecial[3]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[15][2], `Sugar lumps mature <b>${15 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[15][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [19, 36], 550, -2500, [sugarLumpSpecial[3]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[16][2], `Sugar lumps mature <b>${16 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[16][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [20, 36], -650, -2900, [sugarLumpSpecial[6]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[17][2], `Sugar lumps mature <b>${17 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[17][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [32, 36], -350, -2900, [sugarLumpSpecial[6]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[18][2], `Sugar lumps mature <b>${18 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[18][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [33, 36], -50, -2900, [sugarLumpSpecial[6]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[19][2], `Sugar lumps mature <b>${19 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[19][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [34, 36], 250, -2900, [sugarLumpSpecial[6]]);
        ...
        CCSE.NewHeavenlyUpgrade(buildingTiers[20][2], `Sugar lumps mature <b>${20 * scalingBaseReduce / second} seconds</b> sooner per ${Game.Objects[buildingTiers[20][0]].dname}.`, heavenlyUpgradeBase * (heavenlyUpgradePow ** lumpUpgrade++), [35, 36], 550, -2900, [sugarLumpSpecial[6]]);
        ...
        Game.customComputeLumpTimes.push(function() {
            ...
            if (Game.Has(sugarLumpSpecial[1]))
                minMatureTime -= hour * 11
            if (Game.Has(sugarLumpSpecial[2]))
                minMatureTime -= minute * 18;
            if (Game.Has(sugarLumpSpecial[3]))
                minMatureTime -= minute * 18;
            if (Game.Has(sugarLumpSpecial[4]))
                minMatureTime -= minute * 18;
            ...
            for (let i = 1; i <= Object.keys(buildingTiers).length; i++) {
                ...
                if (buildingTiers[i][2] && Game.Has(buildingTiers[i][2]))
                    Game.lumpMatureAge -= scalingBaseReduce * i * Game.Objects[buildingConvertor(buildingTiers[i][0])].amount;
            }
            ;
        ...
        Game.customComputeLumpTimes.push(function offlineLumps() {
            if (Game.Has(sugarLumpSpecial[5]))
                Game.gainLumps(Math.floor((Math.abs(Date.now() - Game.lastDate) / Game.lumpOverripeAge)));
        ...
        newGamePlus.descFunc = function() {
            ...
            return ('<div style="text-align:center;">' + str + '<br>' + 'You are on your <b>' + amount + ' journey</b> to uncover the truth about cookies.<br>' + 'You can start another journey once you\'ve purchased all heavenly upgrades.<br>' + '<div class="line"></div>' + 'All <b>heavenly upgrades</b> will be sacrificed.<br>All your <b>prestige</b> will be sacrificed.<br>All <b>cookie related stats</b> will be reset.' + '<div class="line"></div>' + 'For each new journey started, you will gain a permanent <b>cookie production multiplier</b>.</br><u>All heavenly upgrades will become more expensive.</u>')
        }
        ...
        newGamePlus.canBuyFunc = function() {
            ...
            for (let i in Game.Upgrades) {
                if (Game.Upgrades[i].pool == 'prestige') {
                    ...
                    if (Game.Has(Game.Upgrades[i].name))
                        currentPrestigeUpgrades++;
                }
            }
        ...
        newGamePlus.clickFunction = function(sure) {
            if (!this.canBuyFunc())
                return;
            if (!sure) {
                Game.Prompt('<id NewGamePlus><h3>' + "Start your next journey?" + '</h3>' + '<div class="block">' + tinyIcon([19, 7]) + '<div class="line"></div>' + "Do you REALLY want to start a new Game?<div class=\"line\"></div>You will lose ALL your heavenly upgrades and prestige. Your cookie production stats will be reset.<div class=\"line\"></div>You will gain a boost to your CpS but all heavenly upgrades will be more expensive!" + '<div class="line"></div>' + "You will keep your achievements, building levels and sugar lumps." + '<div class="optionBox">' + '<a class="option smallFancyButton" style="margin:16px;padding:8px 16px;animation:rainbowCycle 5s infinite ease-in-out,pucker 0.2s ease-out;box-shadow:0px 0px 0px 1px #000,0px 0px 1px 2px currentcolor;background:linear-gradient(to bottom,transparent 0%,currentColor 500%);width:auto;text-align:center;" ' + Game.clickStr + '="PlaySound(\'snd/tick.mp3\');Game.ClosePrompt();Game.Upgrades.NewGamePlus.clickFunction(1);" id="promptOption0">' + "Again!" + '</a>' + '</div>' + '</div>', [["Yes", 'Game.ClosePrompt();Game.Upgrades.NewGamePlus.clickFunction(1);', 'float:left;display:none;'], ["Cancel", 0, 'float:right']]);
            } else {
                if (Game.Has('"egg"'))
                    Game.Lock('"egg"');
        ...
        Game.customDropRateMult.push(function() {
            let dropRate = 1;
            if (Game.Has(utilitySpecial[2]))
                dropRate *= 1 + toPercent(50);
            return dropRate;
        })
    ...
    Game.registerHook('logic', function() {
        if (Game.Has(utilitySpecial[3]) && Game.Objects['Wizard tower']?.minigame?.magic && Game.Objects['Wizard tower']?.minigame?.magicPS)
            Game.Objects['Wizard tower'].minigame.magic += 0.002 - Game.Objects['Wizard tower'].minigame.magicPS;
        if (Game.Has(sugarLumpSpecial[6]))
            Game.Unlock('Golden summoner');
        goldenSummoner.priceLumps = Game.lumps > 1 ? Math.min(Game.lumps, 50) : 1;
        if (Game.Has(utilitySpecial[1]))
            Game.Unlock('NewGamePlus');
        if (Game.Has(utilitySpecial[4]) && Game.T % (Game.fps) === 0 && Math.random() < 1 / 777)
            Game.gainLumps(1);
        if (Game.T % (Game.fps) === 0 && forcedLuckTimer > 0 && Game.Has(utilitySpecial[1]))
            forcedLuckTimer--;
    });
    ...
    Game.registerHook('cps', function(cps) {
        ...
        if (Game.Has(cpsSpecial[5]) && Game.Objects['Farm']?.minigame?.harvestsTotal)
            cpsMultiplier *= 1 + toPointOnePercent(Game.Objects['Farm'].minigame.harvestsTotal);
        if (Game.Has(cpsSpecial[6]) && Game.Objects['Wizard tower']?.minigame?.spellsCastTotal)
            cpsMultiplier *= 1 + toPercent(Game.Objects['Wizard tower'].minigame.spellsCastTotal);
        if (Game.Has(cpsSpecial[7]) && Game.Objects['Temple']?.minigame?.slot) {
            let slots = Game.Objects['Temple'].minigame.slot;
            if (slots[0] === -1)
                cpsMultiplier *= 3 * atheismMultiplier;
            if (slots[1] === -1)
                cpsMultiplier *= 2 * atheismMultiplier;
            if (slots[2] === -1)
                cpsMultiplier *= 1 * atheismMultiplier;
        }
        if (Game.ascensionMode != 1)
    ...
    Game.registerHook('cookiesPerClick', function(cpc) {
        ...
        for (let i = 1; i <= Object.keys(buildingTiers).length; i++) {
            if (buildingTiers[i][4] && Game.Has(buildingTiers[i][4]))
                cpcMultiplier *= 1 + toPercent(Game.Objects[buildingConvertor(buildingTiers[i][0])].level);
        }
    ...
    Game.registerHook('check', function() {
        if (forcedLuckTimer === 0 && !Game.HasAchiev('Just plain lucky') && Game.Has(utilitySpecial[1]))
    ...
    Game.customOptionsMenu.push( () => CCSE.AppendCollapsibleOptionsMenu(MoreHeavenlyUpgradesRemastered.name, '<div class="listing">' + CCSE.MenuHelper.ActionButton("MoreHeavenlyUpgradesRemastered.resetUpgrades();", "Locks all Heavenly Upgrades") + '<label>Consider this if you have negative Heavenly Chips when ascending.</label></div>'));
    ...
    if (CCSE.ConfirmGameVersion(MoreHeavenlyUpgradesRemastered.name, MoreHeavenlyUpgradesRemastered.version, MoreHeavenlyUpgradesRemastered.GameVersion))
        Game.registerMod(MoreHeavenlyUpgradesRemastered.name, MoreHeavenlyUpgradesRemastered);
